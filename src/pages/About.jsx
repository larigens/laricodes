        ...
        <div>
            ...
            >
                ...
                <div className="text-center">
                    ...
                    <h1 className="text-4xl font-bold tracking-tight text-ternary-dark sm:text-6xl">
                        Larissa Guilherme
                    </h1>
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        ...
                        <button onClick={showAbout} className="text-lg font-semibold hover:bg-indigo-600 hover:text-white rounded-md px-3 py-2 leading-6 text-secondary-light">
            ...
            <motion.div
                ...
                className="absolute right-0 top-10 mt-10 rounded-2xl shadow-2xl"
            >
                <div className="p-5 text-primary-light">
                    <p className="text-justify text-md my-2">
                        Software developer with experience in financial services and a background in nutrition. Possessing a strong affinity for numbers,  <span className="bg-gradient-to-r from-secondary-dark to-ternary-dark text-transparent bg-clip-text">programming</span> is where this passion is currently being applied.
                    </p>
                    <p className="text-justify text-md my-2">

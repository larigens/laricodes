...
export default function Contact() {
  ...
  const form = useRef(); // moved form useRef outside handleFormSubmit
    ...
    >
      ...
      <div className={`fixed z-50 inset-0 overflow-y-auto ${showModal ? 'block' : 'hidden'}`}>
        <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div
            className="inline-block align-bottom text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full md:w-2/3 lg:w-1/2"
            role="dialog"
            aria-modal="true"
            aria-labelledby="modal-headline"
          >
            <div className="bg-gray-900 p-4">
              <h3 className="text-lg text-ternary-light font-bold" id="modal-headline">
                {modalTitle}
              </h3>
              <div className="mt-2">
